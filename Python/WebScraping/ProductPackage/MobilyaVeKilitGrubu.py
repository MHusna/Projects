...
def MainFunction():
    ...
    """ URL ADRESLERİ """
    firstUrl = "https://www.enderyapi.com.tr/emagaza/1095/"
    secondUrl = "/mobilya-ve-kilit-grubu"
    fileName = "Mobilya_ve_kilit_RD.xlsx"

    excel = LoadFile(fileName)
    worksheet = PrepareFile(excel)

    """ ANA DÖNGÜ """
    for pageNumber in range (1,23):
