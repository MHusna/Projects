...
def MainFunction():
    ...
    """ URL ADRESLERİ """
    firstUrl = "https://www.enderyapi.com.tr/emagaza/84/"
    secondUrl = "/kaynak-makinalari-ve-ekipmanlari"
    fileName = "Kaynak_makinalari_ve_ekipmanlari_RD.xlsx"

    excel = LoadFile(fileName)
    worksheet = PrepareFile(excel)

    """ SAYFA BAĞLANTISI """
    response = Connection(firstUrl, secondUrl, 1)
