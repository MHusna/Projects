...
def MainFunction():
    ...
    """ URL ADRESLERİ """
    firstUrl = "https://www.enderyapi.com.tr/emagaza/1094/"
    secondUrl = "/boya-ve-dekorasyon-grubu"
    fileName = "Boya_ve_dekorasyon_grubu_RD.xlsx"

    excel = LoadFile(fileName)
    worksheet = PrepareFile(excel)

    """ ANA DÖNGÜ """
    for pageNumber in range (1,26):
